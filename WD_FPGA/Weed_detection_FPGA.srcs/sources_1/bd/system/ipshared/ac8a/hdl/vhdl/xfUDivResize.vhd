...
architecture behav of xfUDivResize is 
    ...
    signal out_res_fu_34_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_return_preg : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal ap_NS_fsm : STD_LOGIC_VECTOR (43 downto 0);
    signal grp_fu_28_p10 : STD_LOGIC_VECTOR (39 downto 0);

    component ip_accel_app_udivdEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ip_accel_app_udivdEe_U54 : component ip_accel_app_udivdEe
    generic map (
        ID => 1,
        NUM_STAGE => 44,
        din0_WIDTH => 40,
    ...
    grp_fu_28_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_d_cast_fu_20_p1),40));
        in_d_cast_fu_20_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(in_d),16));

    out_res_fu_34_p1 <= grp_fu_28_p2(32 - 1 downto 0);
end behav;
