...
entity duplicateMat_Loop_Re is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of duplicateMat_Loop_Re is 
    ...
    signal p_src_cols_load10_loc_4_reg_139 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((p_src_cols_load10_loc_out_full_n = ap_const_logic_0) or (p_src_cols_load10_loc_empty_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                p_src_cols_load10_loc_4_reg_139 <= p_src_cols_load10_loc_dout;
            end if;
        end if;
    end process;
    ...
    icmp_ln95_fu_128_p2 <= "1" when (signed(zext_ln95_fu_124_p1) < signed(p_src_cols_load10_loc_4_reg_139)) else "0";
