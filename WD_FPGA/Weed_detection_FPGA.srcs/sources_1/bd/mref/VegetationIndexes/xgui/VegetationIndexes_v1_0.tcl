...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "k_InputSelectionWidth" -parent ${Page_0}
...
proc update_PARAM_VALUE.k_InputSelectionWidth { PARAM_VALUE.k_InputSelectionWidth } {
	# Procedure called to update k_InputSelectionWidth when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.k_InputSelectionWidth { PARAM_VALUE.k_InputSelectionWidth } {
	# Procedure called to validate k_InputSelectionWidth
	return true
}
...
proc update_MODELPARAM_VALUE.k_InputSelectionWidth { MODELPARAM_VALUE.k_InputSelectionWidth PARAM_VALUE.k_InputSelectionWidth } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.k_InputSelectionWidth}] ${MODELPARAM_VALUE.k_InputSelectionWidth}
}
