...
HD_PWD='D:/GitHub/Weed_Detection/WD_FPGA/Weed_detection_FPGA.runs/system_ip_accel_app_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ip_accel_app_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ip_accel_app_0_0.tcl
