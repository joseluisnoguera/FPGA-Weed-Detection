...
if {[file isfile ip_accel_app.autotvin.dat]} {
	file delete -force ip_accel_app.autotvin.dat
}

if {[file isfile ip_accel_app.autotvout.dat]} {
	file delete -force ip_accel_app.autotvout.dat
}
