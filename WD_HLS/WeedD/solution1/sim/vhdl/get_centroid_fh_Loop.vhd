...
architecture behav of get_centroid_fh_Loop is 
    ...
    signal zext_ln150_fu_158_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln150_reg_368 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln148_fu_146_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln150_1_fu_162_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln150_1_reg_373 : STD_LOGIC_VECTOR (9 downto 0);
    signal icmp_ln150_fu_170_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln150_reg_378 : STD_LOGIC_VECTOR (0 downto 0);
    signal v_fu_203_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal v_reg_386 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal and_ln150_fu_214_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln150_reg_391 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln149_fu_197_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal h_0_i_reg_99 : STD_LOGIC_VECTOR (5 downto 0);
    signal v_0_i_reg_110 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal zext_ln151_1_fu_232_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln150_2_fu_166_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln149_fu_193_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal icmp_ln150_1_fu_209_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal shl_ln_fu_219_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln151_fu_227_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln151_fu_237_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln148_fu_146_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln149_fu_197_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln148_fu_146_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln149_fu_197_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                and_ln150_reg_391 <= and_ln150_fu_214_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln148_fu_146_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                icmp_ln150_reg_378 <= icmp_ln150_fu_170_p2;
                    zext_ln150_1_reg_373(5 downto 0) <= zext_ln150_1_fu_162_p1(5 downto 0);
                    zext_ln150_reg_368(5 downto 0) <= zext_ln150_fu_158_p1(5 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln150_reg_368(31 downto 6) <= "00000000000000000000000000";
    zext_ln150_1_reg_373(9 downto 6) <= "0000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, h_limit_empty_n, v_limit_empty_n, ap_CS_fsm_state2, icmp_ln148_fu_146_p2, ap_CS_fsm_state3, icmp_ln149_fu_197_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln148_fu_146_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    add_ln151_fu_227_p2 <= std_logic_vector(unsigned(zext_ln150_1_reg_373) + unsigned(shl_ln_fu_219_p3));
    and_ln150_fu_214_p2 <= (icmp_ln150_reg_378 and icmp_ln150_1_fu_209_p2);
    and_ln895_fu_271_p2 <= (icmp_ln895_fu_241_p2 and and_ln150_reg_391);
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln148_fu_146_p2)
    begin
        if (((icmp_ln148_fu_146_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln148_fu_146_p2)
    begin
        if (((icmp_ln148_fu_146_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    h_sum_7_fu_284_p3 <= 
        h_sum_fu_253_p2 when (and_ln150_reg_391(0) = '1') else 
        h_sum_6_fu_66;
    h_sum_8_fu_291_p3 <= 
        h_sum_6_fu_66 when (and_ln895_fu_271_p2(0) = '1') else 
        h_sum_7_fu_284_p3;
    h_sum_fu_253_p2 <= std_logic_vector(unsigned(zext_ln150_reg_368) + unsigned(h_sum_6_fu_66));
    icmp_ln148_fu_146_p2 <= "1" when (h_0_i_reg_99 = ap_const_lv6_20) else "0";
    icmp_ln149_fu_197_p2 <= "1" when (v_0_i_reg_110 = ap_const_lv5_17) else "0";
    icmp_ln150_1_fu_209_p2 <= "1" when (unsigned(zext_ln149_fu_193_p1) < unsigned(v_limit_read_reg_355)) else "0";
    icmp_ln150_fu_170_p2 <= "1" when (unsigned(zext_ln150_2_fu_166_p1) < unsigned(h_limit_read_reg_350)) else "0";
    icmp_ln895_fu_241_p2 <= "1" when (micro_roi_data_V_q0 = ap_const_lv8_0) else "0";
    micro_roi_data_V_address0 <= zext_ln151_1_fu_232_p1(10 - 1 downto 0);
    ...
    p_sum_7_fu_299_p3 <= 
        p_sum_fu_258_p2 when (and_ln150_reg_391(0) = '1') else 
        p_sum_6_fu_62;
    p_sum_8_fu_306_p3 <= 
    ...
    v_sum_7_fu_264_p3 <= 
        v_sum_fu_247_p2 when (and_ln150_reg_391(0) = '1') else 
        v_sum_6_fu_70;
    v_sum_8_fu_276_p3 <= 
        v_sum_6_fu_70 when (and_ln895_fu_271_p2(0) = '1') else 
        v_sum_7_fu_264_p3;
    v_sum_fu_247_p2 <= std_logic_vector(unsigned(zext_ln151_fu_237_p1) + unsigned(v_sum_6_fu_70));
    zext_ln149_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(v_0_i_reg_110),8));
    zext_ln150_1_fu_162_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(h_0_i_reg_99),10));
    zext_ln150_2_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(h_0_i_reg_99),16));
    zext_ln150_fu_158_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(h_0_i_reg_99),32));
    zext_ln151_1_fu_232_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln151_fu_227_p2),64));
    zext_ln151_fu_237_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(v_0_i_reg_110),32));
end behav;
