...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ip_accel_app.autotvin.dat"
	set constFileTvOut       "ip_accel_app.autotvout.dat"
	set constFileHdlTvIn     "ip_accel_app.autohdltvin.dat"
	set constFileHdlTvOut    "ip_accel_app.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
