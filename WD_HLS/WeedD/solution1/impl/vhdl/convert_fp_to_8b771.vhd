...
architecture behav of convert_fp_to_8b771 is 
    ...
    signal p_Val2_61_fu_140_p3 : STD_LOGIC_VECTOR (39 downto 0);
    ...
    signal trunc_ln29_i_fu_184_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln851_fu_194_p2 <= std_logic_vector(unsigned(ap_const_lv8_1) + unsigned(trunc_ln29_i_fu_184_p4));
    ...
    p_Val2_61_fu_140_p3 <= (veg_temp_data_V_dout & ap_const_lv8_0);
    ...
    select_ln851_fu_200_p3 <= 
        trunc_ln29_i_fu_184_p4 when (icmp_ln851_fu_178_p2(0) = '1') else 
        add_ln851_fu_194_p2;
    ...
    trunc_ln29_i_fu_184_p4 <= r_V_fu_161_p2(23 downto 16);
    ...
    zext_ln703_fu_148_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Val2_61_fu_140_p3),42));
end behav;
