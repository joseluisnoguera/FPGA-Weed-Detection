...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ap_clk [ create_bd_port -dir I -type clk -freq_hz 20000000.0 ap_clk ]
  set ap_rst_n [ create_bd_port -dir I -type rst ap_rst_n ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:ip_accel_app:1.0 hls_inst ]
