...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module extract_third_andKfY_rom (
...
initial begin
    $readmemh("./extract_third_andKfY_rom.dat", ram0);
    $readmemh("./extract_third_andKfY_rom.dat", ram1);
    $readmemh("./extract_third_andKfY_rom.dat", ram2);
end
...
extract_third_andKfY_rom extract_third_andKfY_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
