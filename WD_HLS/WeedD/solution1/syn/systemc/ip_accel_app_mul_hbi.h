...
// ==============================================================
#ifndef __ip_accel_app_mul_hbi__HH__
#define __ip_accel_app_mul_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_mul_hbi) {
    ...
    SC_CTOR(ip_accel_app_mul_hbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
