...
void get_total_vegetatBew::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void get_total_vegetatBew::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void get_total_vegetatBew::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void get_total_vegetatBew::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
