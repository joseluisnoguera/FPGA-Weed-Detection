...
// ==============================================================
#ifndef __ip_accel_app_sdivqcK__HH__
#define __ip_accel_app_sdivqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_sdivqcK) {
    ...
    SC_CTOR(ip_accel_app_sdivqcK):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
