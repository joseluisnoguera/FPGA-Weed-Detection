...
#ifndef _get_total_vegetatBew_H_
#define _get_total_vegetatBew_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "get_total_vegetatBew_memcore.h"

SC_MODULE(get_total_vegetatBew) {
...
protected:
    ...
    get_total_vegetatBew_memcore* get_total_vegetatBew_memcore_U;
...
public:
    ...
    SC_CTOR(get_total_vegetatBew) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        get_total_vegetatBew_memcore_U = new get_total_vegetatBew_memcore("get_total_vegetatBew_memcore_U");
        get_total_vegetatBew_memcore_U->clk      ( clk );
        get_total_vegetatBew_memcore_U->reset    ( reset );
        get_total_vegetatBew_memcore_U->ce0      ( i_ce0 );
        get_total_vegetatBew_memcore_U->address0 ( memcore_iaddr );
        get_total_vegetatBew_memcore_U->q0       ( i_q0 );

        get_total_vegetatBew_memcore_U->ce1      ( t_ce0 );
        get_total_vegetatBew_memcore_U->address1 ( memcore_taddr );
        get_total_vegetatBew_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "get_total_vegetatBew.trace");
            // ports
