...
#ifndef _xFDuplicate645_HH_
#define _xFDuplicate645_HH_
...
struct xFDuplicate645 : public sc_module {
    ...
    // Module declarations
    xFDuplicate645(sc_module_name name);
    SC_HAS_PROCESS(xFDuplicate645);
    ...
    sc_signal< sc_lv<8> > t_V_8_reg_88;
