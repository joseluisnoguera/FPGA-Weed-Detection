...
#ifndef _xFDuplicate_2_HH_
#define _xFDuplicate_2_HH_
...
struct xFDuplicate_2 : public sc_module {
    ...
    // Module declarations
    xFDuplicate_2(sc_module_name name);
    SC_HAS_PROCESS(xFDuplicate_2);
    ...
    sc_signal< sc_lv<1> > icmp_ln56_reg_151;
    ...
    sc_signal< sc_lv<10> > row_V_fu_120_p2;
    sc_signal< sc_lv<10> > row_V_reg_146;
    sc_signal< sc_lv<1> > icmp_ln56_fu_126_p2;
    ...
    sc_signal< sc_lv<10> > t_V_11_reg_88;
    ...
    void thread_icmp_ln56_fu_126_p2();
