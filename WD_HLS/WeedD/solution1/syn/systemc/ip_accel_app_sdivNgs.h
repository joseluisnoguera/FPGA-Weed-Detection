...
// ==============================================================
#ifndef __ip_accel_app_sdivNgs__HH__
#define __ip_accel_app_sdivNgs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_sdivNgs) {
    ...
    SC_CTOR(ip_accel_app_sdivNgs):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
