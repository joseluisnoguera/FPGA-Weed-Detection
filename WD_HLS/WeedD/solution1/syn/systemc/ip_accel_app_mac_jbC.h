...
// ==============================================================
#ifndef __ip_accel_app_mac_jbC__HH__
#define __ip_accel_app_mac_jbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_mac_jbC) {
    ...
    SC_CTOR(ip_accel_app_mac_jbC):  simcore_mac_0_U ("simcore_mac_0_U") {
