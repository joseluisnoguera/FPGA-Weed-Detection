...
// ==============================================================
#ifndef __ip_accel_app_udivHfu__HH__
#define __ip_accel_app_udivHfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_udivHfu) {
    ...
    SC_CTOR(ip_accel_app_udivHfu):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
