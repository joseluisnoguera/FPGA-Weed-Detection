...
// ==============================================================
#ifndef __ip_accel_app_udivbak__HH__
#define __ip_accel_app_udivbak__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_udivbak) {
    ...
    ACMP_udiv_seq<ID, 49, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_udiv_seq_U;

    SC_CTOR(ip_accel_app_udivbak):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
