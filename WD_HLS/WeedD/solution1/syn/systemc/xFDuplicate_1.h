...
#ifndef _xFDuplicate_1_HH_
#define _xFDuplicate_1_HH_
...
struct xFDuplicate_1 : public sc_module {
    ...
    // Module declarations
    xFDuplicate_1(sc_module_name name);
    SC_HAS_PROCESS(xFDuplicate_1);
    ...
    sc_signal< sc_lv<8> > t_V_11_reg_88;
