...
// ==============================================================
#ifndef __ip_accel_app_mul_QgW__HH__
#define __ip_accel_app_mul_QgW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_mul_QgW) {
    ...
    SC_CTOR(ip_accel_app_mul_QgW):  ACMP_mul_su_U ("ACMP_mul_su_U") {
