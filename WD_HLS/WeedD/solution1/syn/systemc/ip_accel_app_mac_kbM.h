...
// ==============================================================
#ifndef __ip_accel_app_mac_kbM__HH__
#define __ip_accel_app_mac_kbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_mac_kbM) {
    ...
    SC_CTOR(ip_accel_app_mac_kbM):  simcore_mac_1_U ("simcore_mac_1_U") {
