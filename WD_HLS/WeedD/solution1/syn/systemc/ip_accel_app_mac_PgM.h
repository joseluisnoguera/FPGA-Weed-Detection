...
// ==============================================================
#ifndef __ip_accel_app_mac_PgM__HH__
#define __ip_accel_app_mac_PgM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_accel_app_mac_PgM) {
    ...
    SC_CTOR(ip_accel_app_mac_PgM):  simcore_mac_2_U ("simcore_mac_2_U") {
