set moduleName get_vegetation_image_2
set isTopModule 0
...
set C_modelName {get_vegetation_image.2}
set C_modelType { int 24 }
set C_modelArgList {
	{ min_value_V int 28 regular {fifo 0}  }
	{ p_read int 24 regular  }
	{ min_value_V_out int 28 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "min_value_V", "interface" : "fifo", "bitwidth" : 28, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ min_value_V_dout sc_in sc_lv 28 signal 0 } 
	{ min_value_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ min_value_V_read sc_out sc_logic 1 signal 0 } 
	{ p_read sc_in sc_lv 24 signal 1 } 
	{ min_value_V_out_din sc_out sc_lv 28 signal 2 } 
	{ min_value_V_out_full_n sc_in sc_logic 1 signal 2 } 
	{ min_value_V_out_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "min_value_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "min_value_V", "role": "dout" }} , 
 	{ "name": "min_value_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "min_value_V", "role": "empty_n" }} , 
 	{ "name": "min_value_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "min_value_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "min_value_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	min_value_V { ap_fifo {  { min_value_V_dout fifo_data 0 28 }  { min_value_V_empty_n fifo_status 0 1 }  { min_value_V_read fifo_update 1 1 } } }
