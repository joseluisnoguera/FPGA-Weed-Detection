set moduleName duplicateMat_Loop_2_1
set isTopModule 0
...
set C_modelName {duplicateMat_Loop_2_.1}
...
set portList { 
	...
	{ dst_V_V_dout sc_in sc_lv 24 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "p_dst1_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "call_ln114_write_1_fu_90", "Port" : "Mat_9_180_320_1_data_V_addr"}]},
			...
			{"Name" : "p_dst2_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "call_ln115_write_1_fu_98", "Port" : "Mat_9_180_320_1_data_V_addr"}]}],
		"SubInstanceBlock" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln114_write_1_fu_90", "Parent" : "0",
		"CDFG" : "write_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln115_write_1_fu_98", "Parent" : "0",
		"CDFG" : "write_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
