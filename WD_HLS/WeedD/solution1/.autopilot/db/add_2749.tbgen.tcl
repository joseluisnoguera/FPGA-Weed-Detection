...
set C_modelName {add_2749}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_src1_data_V int 24 regular {fifo 0 volatile }  }
	{ p_src2_data_V int 24 regular {fifo 0 volatile }  }
	{ p_dst_data_V int 24 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_src1_data_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "p_src2_data_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_src1_data_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "p_src1_data_V", "role": "dout" }} , 
 	...
 	{ "name": "p_src2_data_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "p_src2_data_V", "role": "dout" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "p_src1_data_V", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_xFarithm_proc_2811_fu_20", "Port" : "p_src1_data_V"}]},
			{"Name" : "p_src2_data_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_xFarithm_proc_2811_fu_20", "Port" : "p_src2_data_V"}]},
			{"Name" : "p_dst_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_xFarithm_proc_2811_fu_20", "Port" : "p_dst_data_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_xFarithm_proc_2811_fu_20", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "923762", "Max" : "923762"}
	, {"Name" : "Interval", "Min" : "923762", "Max" : "923762"}
]}
...
set Spec2ImplPortList { 
	p_src1_data_V { ap_fifo {  { p_src1_data_V_dout fifo_data 0 24 }  { p_src1_data_V_empty_n fifo_status 0 1 }  { p_src1_data_V_read fifo_update 1 1 } } }
	p_src2_data_V { ap_fifo {  { p_src2_data_V_dout fifo_data 0 24 }  { p_src2_data_V_empty_n fifo_status 0 1 }  { p_src2_data_V_read fifo_update 1 1 } } }
