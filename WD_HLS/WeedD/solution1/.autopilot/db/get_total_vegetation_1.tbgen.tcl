set moduleName get_total_vegetation_1
set isTopModule 0
...
set C_modelName {get_total_vegetation.1}
...
set portList { 
	...
	{ img_in_data_V_address0 sc_out sc_lv 16 signal 0 } 
	{ img_in_data_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ img_in_data_V_q0 sc_in sc_lv 8 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "img_in_data_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "28802", "Max" : "28802"}
]}
...
set Spec2ImplPortList { 
	img_in_data_V { ap_memory {  { img_in_data_V_address0 mem_address 1 16 }  { img_in_data_V_ce0 mem_ce 1 1 }  { img_in_data_V_q0 mem_dout 0 8 } } }
}
