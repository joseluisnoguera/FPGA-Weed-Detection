...
set C_modelName {xFDuplicate645}
set C_modelType { void 0 }
set C_modelArgList {
	{ src_V_V int 24 regular {fifo 0 volatile }  }
	{ dst_V_V int 24 regular {fifo 1 volatile }  }
	{ dst1_V_V int 24 regular {fifo 1 volatile }  }
	{ p_src_cols_load10_loc int 10 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_V_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "dst_V_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "dst1_V_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ src_V_V_dout sc_in sc_lv 24 signal 0 } 
	{ src_V_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ src_V_V_read sc_out sc_logic 1 signal 0 } 
	{ dst_V_V_din sc_out sc_lv 24 signal 1 } 
	{ dst_V_V_full_n sc_in sc_logic 1 signal 1 } 
	{ dst_V_V_write sc_out sc_logic 1 signal 1 } 
	{ dst1_V_V_din sc_out sc_lv 24 signal 2 } 
	{ dst1_V_V_full_n sc_in sc_logic 1 signal 2 } 
	{ dst1_V_V_write sc_out sc_logic 1 signal 2 } 
	{ p_src_cols_load10_loc_dout sc_in sc_lv 10 signal 3 } 
	{ p_src_cols_load10_loc_empty_n sc_in sc_logic 1 signal 3 } 
	{ p_src_cols_load10_loc_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "src_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "src_V_V", "role": "dout" }} , 
 	...
 	{ "name": "dst_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "dst_V_V", "role": "din" }} , 
 	...
 	{ "name": "dst1_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "dst1_V_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	src_V_V { ap_fifo {  { src_V_V_dout fifo_data 0 24 }  { src_V_V_empty_n fifo_status 0 1 }  { src_V_V_read fifo_update 1 1 } } }
	dst_V_V { ap_fifo {  { dst_V_V_din fifo_data 1 24 }  { dst_V_V_full_n fifo_status 0 1 }  { dst_V_V_write fifo_update 1 1 } } }
	dst1_V_V { ap_fifo {  { dst1_V_V_din fifo_data 1 24 }  { dst1_V_V_full_n fifo_status 0 1 }  { dst1_V_V_write fifo_update 1 1 } } }
