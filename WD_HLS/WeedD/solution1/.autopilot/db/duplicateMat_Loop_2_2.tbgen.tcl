set moduleName duplicateMat_Loop_2_2
set isTopModule 0
...
set C_modelName {duplicateMat_Loop_2_.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst_V_V int 8 regular {fifo 0 volatile }  }
	{ p_dst1_data_V int 8 regular {array 57600 { 0 3 } 0 1 }  }
	{ dst1_V_V int 8 regular {fifo 0 volatile }  }
	{ p_dst2_data_V int 8 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dst_V_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_dst1_data_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "dst1_V_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ dst_V_V_dout sc_in sc_lv 8 signal 0 } 
	{ dst_V_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ dst_V_V_read sc_out sc_logic 1 signal 0 } 
	...
	{ dst1_V_V_dout sc_in sc_lv 8 signal 2 } 
	{ dst1_V_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ dst1_V_V_read sc_out sc_logic 1 signal 2 } 
	{ p_dst2_data_V_din sc_out sc_lv 8 signal 3 } 
	{ p_dst2_data_V_full_n sc_in sc_logic 1 signal 3 } 
	{ p_dst2_data_V_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "dst_V_V", "role": "dout" }} , 
 	...
 	{ "name": "dst1_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "dst1_V_V", "role": "dout" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "p_dst2_data_V", "Type" : "Fifo", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "call_ln115_write797_fu_112", "Port" : "Mat_0_180_320_1_data_V_addr"}]}],
		"SubInstanceBlock" : [
			{"SubInstance" : "call_ln115_write797_fu_112", "SubBlockPort" : ["Mat_0_180_320_1_data_V_addr_blk_n"]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln115_write797_fu_112", "Parent" : "0",
		"CDFG" : "write797",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	dst_V_V { ap_fifo {  { dst_V_V_dout fifo_data 0 8 }  { dst_V_V_empty_n fifo_status 0 1 }  { dst_V_V_read fifo_update 1 1 } } }
	p_dst1_data_V { ap_memory {  { p_dst1_data_V_address0 mem_address 1 16 }  { p_dst1_data_V_ce0 mem_ce 1 1 }  { p_dst1_data_V_we0 mem_we 1 1 }  { p_dst1_data_V_d0 mem_din 1 8 } } }
	dst1_V_V { ap_fifo {  { dst1_V_V_dout fifo_data 0 8 }  { dst1_V_V_empty_n fifo_status 0 1 }  { dst1_V_V_read fifo_update 1 1 } } }
