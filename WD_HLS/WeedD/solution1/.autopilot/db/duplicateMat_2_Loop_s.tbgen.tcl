set moduleName duplicateMat_2_Loop_s
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "p_src_cols_load6_loc", "interface" : "fifo", "bitwidth" : 12, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_src_cols_load6_loc_out", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_src_cols_load6_loc_dout sc_in sc_lv 12 signal 0 } 
	{ p_src_cols_load6_loc_empty_n sc_in sc_logic 1 signal 0 } 
	{ p_src_cols_load6_loc_read sc_out sc_logic 1 signal 0 } 
	...
	{ p_src_cols_load6_loc_out_din sc_out sc_lv 12 signal 3 } 
	{ p_src_cols_load6_loc_out_full_n sc_in sc_logic 1 signal 3 } 
	{ p_src_cols_load6_loc_out_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_src_cols_load6_loc_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "p_src_cols_load6_loc_out", "role": "din" }} , 
 	{ "name": "p_src_cols_load6_loc_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_src_cols_load6_loc_out", "role": "full_n" }} , 
 	{ "name": "p_src_cols_load6_loc_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_src_cols_load6_loc_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "p_src_data_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "tmp_V_read765_fu_105", "Port" : "Mat_9_720_1280_1_data_V_addr"}]},
			{"Name" : "src_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "src_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_src_cols_load6_loc_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_V_read765_fu_105", "Parent" : "0",
		"CDFG" : "read765",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2881", "Max" : "923761"}
	, {"Name" : "Interval", "Min" : "2881", "Max" : "923761"}
]}
...
set Spec2ImplPortList { 
	...
	p_src_cols_load6_loc_out { ap_fifo {  { p_src_cols_load6_loc_out_din fifo_data 1 12 }  { p_src_cols_load6_loc_out_full_n fifo_status 0 1 }  { p_src_cols_load6_loc_out_write fifo_update 1 1 } } }
}
