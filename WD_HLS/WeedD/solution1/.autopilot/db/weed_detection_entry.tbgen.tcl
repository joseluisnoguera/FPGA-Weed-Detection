set moduleName weed_detection_entry
set isTopModule 0
...
set C_modelName {weed_detection.entry}
set C_modelType { void 0 }
set C_modelArgList {
	{ img_in_cols int 12 regular {pointer 0}  }
	{ img_in_cols_out int 12 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "img_in_cols", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "img_in_cols_out", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_in_cols_out_din sc_out sc_lv 12 signal 1 } 
	{ img_in_cols_out_full_n sc_in sc_logic 1 signal 1 } 
	{ img_in_cols_out_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_in_cols_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "img_in_cols_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	img_in_cols { ap_none {  { img_in_cols in_data 0 12 } } }
	img_in_cols_out { ap_fifo {  { img_in_cols_out_din fifo_data 1 12 }  { img_in_cols_out_full_n fifo_status 0 1 }  { img_in_cols_out_write fifo_update 1 1 } } }
}
