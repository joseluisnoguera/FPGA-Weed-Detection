set moduleName duplicateMat_2762
set isTopModule 0
...
set C_modelName {duplicateMat_2762}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "5", "8", "9", "10", "11", "12", "13", "14", "15", "16"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "duplicateMat_2_Block_U0", "ReadyCount" : "duplicateMat_2_Block_U0_ap_ready_count"},
			{"ID" : "2", "Name" : "duplicateMat_2_Loop_U0", "ReadyCount" : "duplicateMat_2_Loop_U0_ap_ready_count"}],
		"OutputProcess" : [
			{"ID" : "5", "Name" : "duplicateMat_2_Loop_1_U0"}],
		"Port" : [
			{"Name" : "p_src_cols", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "duplicateMat_2_Block_U0", "Port" : "p_src_cols"}]},
			{"Name" : "p_src_data_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "duplicateMat_2_Loop_U0", "Port" : "p_src_data_V"}]},
			{"Name" : "p_dst1_rows", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "duplicateMat_2_Block_U0", "Port" : "p_dst1_rows"}]},
			{"Name" : "p_dst1_cols", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "duplicateMat_2_Block_U0", "Port" : "p_dst1_cols"}]},
			{"Name" : "p_dst1_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "duplicateMat_2_Loop_1_U0", "Port" : "p_dst1_data_V"}]},
			{"Name" : "p_dst2_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "duplicateMat_2_Loop_1_U0", "Port" : "p_dst2_data_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.duplicateMat_2_Block_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "p_src_cols_load6_out_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "2", "DependentChan" : "8",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.duplicateMat_2_Loop_U0", "Parent" : "0", "Child" : ["3"],
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "p_src_cols_load6_loc", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "8",
				"BlockSignal" : [
			...
			{"Name" : "p_src_data_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "tmp_V_read765_fu_105", "Port" : "Mat_9_720_1280_1_data_V_addr"}]},
			{"Name" : "src_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "4", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "src_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_src_cols_load6_loc_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "4", "DependentChan" : "12",
				"BlockSignal" : [
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.duplicateMat_2_Loop_U0.tmp_V_read765_fu_105", "Parent" : "2",
		"CDFG" : "read765",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.xFDuplicate_2_U0", "Parent" : "0",
		"CDFG" : "xFDuplicate_2",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "p_src_mat_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "11",
				"BlockSignal" : [
					{"Name" : "p_src_mat_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_dst1_mat_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "5", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "p_dst1_mat_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_dst2_mat_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "5", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "p_dst2_mat_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_src_cols_load6_loc", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "12",
				"BlockSignal" : [
					{"Name" : "p_src_cols_load6_loc_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.duplicateMat_2_Loop_1_U0", "Parent" : "0", "Child" : ["6", "7"],
		...
		"Port" : [
			...
			{"Name" : "p_dst1_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "call_ln113_write_r_fu_100", "Port" : "Mat_9_720_1280_1_data_V_addr"}]},
			...
			{"Name" : "p_dst2_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "call_ln114_write_r_fu_108", "Port" : "Mat_9_720_1280_1_data_V_addr"}]}],
		"SubInstanceBlock" : [
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.duplicateMat_2_Loop_1_U0.call_ln113_write_r_fu_100", "Parent" : "5",
		"CDFG" : "write_r",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "Mat_9_720_1280_1_data_V_addr", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "Mat_9_720_1280_1_data_V_addr_blk_n", "Type" : "RtlPort"}]}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.duplicateMat_2_Loop_1_U0.call_ln114_write_r_fu_108", "Parent" : "5",
		"CDFG" : "write_r",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "Mat_9_720_1280_1_data_V_addr", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "Mat_9_720_1280_1_data_V_addr_blk_n", "Type" : "RtlPort"}]}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_src_cols_load6_loc_1_U", "Parent" : "0"},
	...
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_src_cols_load6_loc_s_U", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dst_V_V_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dst1_V_V_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_duplicabkb_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_xFDuplicud_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "174963", "Max" : "924003"}
	, {"Name" : "Interval", "Min" : "174962", "Max" : "923762"}
]}
...
set Spec2ImplPortList { 
	...
	p_dst1_rows { ap_none {  { p_dst1_rows in_data 0 11 }  { p_dst1_rows_ap_vld in_vld 0 1 } } }
	p_dst1_cols { ap_none {  { p_dst1_cols in_data 0 12 }  { p_dst1_cols_ap_vld in_vld 0 1 } } }
