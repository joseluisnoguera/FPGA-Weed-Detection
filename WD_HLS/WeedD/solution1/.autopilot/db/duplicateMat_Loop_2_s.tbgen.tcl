set moduleName duplicateMat_Loop_2_s
set isTopModule 0
...
set C_modelName {duplicateMat_Loop_2_}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_dst1_rows int 9 regular {fifo 0}  }
	{ p_dst1_cols int 10 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_dst1_rows", "interface" : "fifo", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "p_dst1_cols", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_dst1_rows_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "p_dst1_rows", "role": "dout" }} , 
 	...
 	{ "name": "p_dst1_cols_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "p_dst1_cols", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "p_dst1_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "call_ln114_write_1_fu_100", "Port" : "Mat_9_180_320_1_data_V_addr"}]},
			...
			{"Name" : "p_dst2_data_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "call_ln115_write_1_fu_108", "Port" : "Mat_9_180_320_1_data_V_addr"}]}],
		"SubInstanceBlock" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln114_write_1_fu_100", "Parent" : "0",
		"CDFG" : "write_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln115_write_1_fu_108", "Parent" : "0",
		"CDFG" : "write_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5", "Max" : "58141"}
	, {"Name" : "Interval", "Min" : "5", "Max" : "58141"}
]}
...
set Spec2ImplPortList { 
	p_dst1_rows { ap_fifo {  { p_dst1_rows_dout fifo_data 0 9 }  { p_dst1_rows_empty_n fifo_status 0 1 }  { p_dst1_rows_read fifo_update 1 1 } } }
	p_dst1_cols { ap_fifo {  { p_dst1_cols_dout fifo_data 0 10 }  { p_dst1_cols_empty_n fifo_status 0 1 }  { p_dst1_cols_read fifo_update 1 1 } } }
