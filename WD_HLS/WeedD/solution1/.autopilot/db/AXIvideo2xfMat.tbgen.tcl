...
set C_modelArgList {
	{ AXI_video_strm_V_data_V int 32 regular {axi_s 0 volatile  { stream_in Data } }  }
	{ AXI_video_strm_V_keep_V int 4 regular {axi_s 0 volatile  { stream_in Keep } }  }
	{ AXI_video_strm_V_strb_V int 4 regular {axi_s 0 volatile  { stream_in Strb } }  }
	...
	{ img_data_V int 24 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "AXI_video_strm_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "img_data_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_data_V_din sc_out sc_lv 24 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_in_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "stream_in_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "stream_in_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	...
 	{ "name": "img_data_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "img_data_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { stream_in_TDATA in_data 0 32 } } }
	AXI_video_strm_V_keep_V { axis {  { stream_in_TKEEP in_data 0 4 } } }
	AXI_video_strm_V_strb_V { axis {  { stream_in_TSTRB in_data 0 4 } } }
	...
	img_data_V { ap_fifo {  { img_data_V_din fifo_data 1 24 }  { img_data_V_full_n fifo_status 0 1 }  { img_data_V_write fifo_update 1 1 } } }
}
