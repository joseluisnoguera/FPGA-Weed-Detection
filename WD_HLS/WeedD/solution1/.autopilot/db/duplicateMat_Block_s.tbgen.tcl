set moduleName duplicateMat_Block_s
set isTopModule 0
...
set C_modelName {duplicateMat_Block__}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_src_cols int 10 regular {fifo 0}  }
	{ p_src_cols_load10_out_out int 10 regular {fifo 1}  }
	{ p_dst1_rows int 9 regular {pointer 0}  }
	{ p_dst1_cols int 10 regular {pointer 0}  }
	{ p_dst1_rows_out int 9 regular {fifo 1}  }
	{ p_dst1_cols_out int 10 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_src_cols", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "p_src_cols_load10_out_out", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "p_dst1_rows_out", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_dst1_cols_out", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_src_cols_load10_out_out_din sc_out sc_lv 10 signal 1 } 
	{ p_src_cols_load10_out_out_full_n sc_in sc_logic 1 signal 1 } 
	{ p_src_cols_load10_out_out_write sc_out sc_logic 1 signal 1 } 
	{ p_dst1_rows sc_in sc_lv 9 signal 2 } 
	{ p_dst1_cols sc_in sc_lv 10 signal 3 } 
	{ p_dst1_rows_out_din sc_out sc_lv 9 signal 4 } 
	{ p_dst1_rows_out_full_n sc_in sc_logic 1 signal 4 } 
	{ p_dst1_rows_out_write sc_out sc_logic 1 signal 4 } 
	{ p_dst1_cols_out_din sc_out sc_lv 10 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_src_cols_load10_out_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "p_src_cols_load10_out_out", "role": "din" }} , 
 	{ "name": "p_src_cols_load10_out_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_src_cols_load10_out_out", "role": "full_n" }} , 
 	{ "name": "p_src_cols_load10_out_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_src_cols_load10_out_out", "role": "write" }} , 
 	...
 	{ "name": "p_dst1_rows_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "p_dst1_rows_out", "role": "din" }} , 
 	...
 	{ "name": "p_dst1_cols_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "p_dst1_cols_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "p_src_cols_load10_out_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	p_src_cols_load10_out_out { ap_fifo {  { p_src_cols_load10_out_out_din fifo_data 1 10 }  { p_src_cols_load10_out_out_full_n fifo_status 0 1 }  { p_src_cols_load10_out_out_write fifo_update 1 1 } } }
	p_dst1_rows { ap_none {  { p_dst1_rows in_data 0 9 } } }
	p_dst1_cols { ap_none {  { p_dst1_cols in_data 0 10 } } }
	p_dst1_rows_out { ap_fifo {  { p_dst1_rows_out_din fifo_data 1 9 }  { p_dst1_rows_out_full_n fifo_status 0 1 }  { p_dst1_rows_out_write fifo_update 1 1 } } }
	p_dst1_cols_out { ap_fifo {  { p_dst1_cols_out_din fifo_data 1 10 }  { p_dst1_cols_out_full_n fifo_status 0 1 }  { p_dst1_cols_out_write fifo_update 1 1 } } }
}
